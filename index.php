    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="tchat/index.php?page=signin">Se connecter</a></li>
    ...
    <section id="about" class="about">
      ...
      <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Pour toute vos préocupations.</h3>
            <p class="font-italic">
               Une équipe d'avocat expert à votre écoute.
            </p>
            <ul>
              <li><i class="icofont-check-circled"></i> Disponible 24h/24 ; 7j/7.</li>
              <li><i class="icofont-check-circled"></i> Une équipe Professionelle..</li>
              <li><i class="icofont-check-circled"></i> Un service fiable , rapide et à moindre coût.</li>
            </ul>
            <p>
              Pour repondre à toutes les questions de droit et vous orientez , Avocat Rapide est disponible pour vous conseiller à tout moment et vous orientez  <div class=""></div>
            </p>
          </div>
        </div>
